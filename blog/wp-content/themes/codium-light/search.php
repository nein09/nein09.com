...
<div id="container">
	<div id="content" class="sixteen columns">
		...
		<div class="dp100 infocontainer justif">
			<h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'codium_light' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
			<div class="hr"></div>
		</div>
		<?php if (have_posts()) : ?>  
		...
		<?php endwhile;  ?>
		<?php else : ?>
		<div id="post-0" class="post no-results not-found dp100 infocontainer justif">
