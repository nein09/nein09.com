...
<div id="containerlarge">
	<div id="content" class="sixteen columns">
		...
		<div class="dp100 infocontainer justif">
			<h1 class="page-title">
				<?php if ( is_day() ) : ?>
				<?php printf( __( 'Daily Archives: <span>%s</span>', 'codium_light' ), get_the_date() ); ?>
				<?php elseif ( is_month() ) : ?>
				<?php printf( __( 'Monthly Archives: <span>%s</span>', 'codium_light' ), get_the_date('F Y') ); ?>
				<?php elseif ( is_year() ) : ?>
				<?php printf( __( 'Yearly Archives: <span>%s</span>', 'codium_light' ), get_the_date('Y') ); ?>
				<?php else : ?>
				<?php _e( 'Blog Archives', 'codium_light' ); ?>
				<?php endif; ?>
			</h1>
			<div class="hr"></div>
		</div>
